...
export default defineComparison({
  ...
  ourStrengths: [
    ...
    },
    {
      ...
      body:
        "On Pro, give it up to 50 knowledge entries and it answers mid-survey, then carries on from the same question. Letting people clarify a question is one of the oldest findings in survey research for reducing error.",
    },
    {
