...
function Usage() {
  ...
  if (ent.isError && !d) {
    return (
      <>
        <h2 className="font-display text-h2 mb-5">Plan &amp; usage</h2>
        <EmptyState
          icon={TriangleAlert}
    ...
    <>
      <header className="mb-6 flex flex-wrap items-start justify-between gap-x-4 gap-y-4">
        <div className="min-w-0">
          <h2 className="font-display text-h2">Plan &amp; usage</h2>
...
/** Shaped like the section it precedes, so nothing jumps when the answer lands. */
