        ...
        <dl className="mt-12 grid gap-x-12 gap-y-9 sm:grid-cols-2">
          {[
            ...
            },
            {
              ...
              def: "Schober and Conrad found that letting an interviewer clarify sharply reduces error. Give it your documents, pages and notes as a knowledge base and it answers from them, quoting you, then carries on exactly where it was.",
            },
            {
