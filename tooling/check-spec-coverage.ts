...
const DASHBOARD_ONLY: Record<string, string> = {
  ...
  "/api/workspaces/{id}/members": "who may open a workspace is an admin's decision about people; a key acts org-wide and grants nothing",
  "/api/workspaces/{id}/members/{memberId}": "see /api/workspaces/{id}/members",
  "/api/workspace-access": "see /api/workspaces/{id}/members",
  "/api/members/{memberId}/access": "see /api/workspaces/{id}/members",
  "/api/invitations": "inviting a person needs a signed-in person; Better Auth sends the email as the inviter",
  ...
  "/api/admin/feedback/stats": "see /api/admin/feedback",
  "/api/admin/feedback/reports": "see /api/admin/feedback",
  "/api/admin/feedback/reports/{id}": "see /api/admin/feedback",
  "/api/admin/feedback/reports/{id}/snapshot": "see /api/admin/feedback",
  "/api/admin/feedback/issues": "see /api/admin/feedback",
  "/api/admin/feedback/issues/{id}": "see /api/admin/feedback",
  "/api/admin/feedback/issues/{id}/merge": "see /api/admin/feedback",
